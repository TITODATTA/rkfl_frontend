...
const Rules = ({ selectedOption }) => {
    return (
        <div className={css.main_container}>
            ...
            <h5>5)In Section 24 for <span style={{ color: "blue" }}>"Home Loan Interest"</span><span style={{ color: "red" }}></span><span style={{ color: "red" }}>Pan,Name,Address of Financial Institution</span> is <span style={{ color: "red" }}>mandatory</span>.</h5>
            <h5>6)If something was <span style={{ color: "blue" }}>Edited</span>remember to submit the data by clicking "Submit" , otherwise changes wont be saved.</h5>
            {selectedOption === "provisional" &&
                <>
                    <h5>7)Mutiple Files can be uploaded for a single investment by clicking on Upload more in the Edit Mode or in the table while adding a investment </h5>
                    <h5>8)<span style={{ color: "blue" }}>File Name</span> needs to have a correct format :- <span style={{ color: "blue" }}>"EmployeeCode(In Number)_FileName(text)"</span></h5>
                    <h5>9)<span style={{ color: "blue" }}>File Size</span> needs to below <span style={{ color: "blue" }}>200KB</span></h5>
                </>
            }
            {selectedOption === "actual" && <>
                <h5>7)To upload files , click on edit option , and choose the button "Choose File".</h5>
                <h5>8)Mutiple Files can be uploaded for a single investment by clicking on upload more in the edit option</h5>
                ...
                <h5>11)<span style={{ color: "blue" }}>Conversion Process</span> needs to carried out for all sections and investments</h5>
                <h5>12)<span style={{ color: "blue" }}>After conversion,</span> you cannot edit or delete the provisional entry .</h5>
                <h5>13)<span style={{ color: "blue" }}>After Final submission</span> you can add entries ,but cannot edit or delete</h5>
                <h5>15)To check click the Actual Radio Button , for verification/edit/delete</h5>
            </>}

            <h5>
                {selectedOption === "provisional" ? "10" : "16"})Symbols :
